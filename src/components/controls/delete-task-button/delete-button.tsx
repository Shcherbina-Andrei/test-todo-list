...
function DeleteButton({handleDeleteButton}: propsType): JSX.Element {
  return (
    <Button handleAction={handleDeleteButton} styleClass={'common__button--delete'}>
      <svg className="common__delete-icon" viewBox="0 0 512 512" width="30" height="30">
